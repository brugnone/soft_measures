"""
Score FCM comparisons for the two Gemini batches generated on 2026-03-01.

  Batch 1 (Gemini 2.5 Flash):
    fcm_adjacency_matrices_fcm_interviews_gemini25flash_20260301_182916
  Batch 2 (Gemini 3 Flash):
    fcm_adjacency_matrices_fcm_interviews_gemini3flash_20260301_182933

Both batches share the same directory structure as previous batches:
  {batch_dir}/{Dataset}/{participant_id}/{file}.csv
      e.g.  Biodiversity/BD001/BD001.csv
            Gulf OSW/AE/...csv
            Red snapper/357392_BeFa_7_26_21/...csv

The model is loaded once and reused across both batches.

Usage:
  python score_20260301.py                  # scores both default batches
  python score_20260301.py <ai_dir> ...     # positional: one or more ai_dirs
"""
...
DEFAULT_BATCHES = [
    r'C:\Users\Nbrug\Desktop\fcm_adjacency_matrices_fcm_interviews_gemini25flash_20260301_182916',
    r'C:\Users\Nbrug\Desktop\fcm_adjacency_matrices_fcm_interviews_gemini3flash_20260301_182933',
]
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        help='One or more AI batch directories to score (default: both 2026-03-01 Gemini batches)',
    )
    ...
    print("=" * 80)
    print("FCM SCORING  –  2026-03-01 Gemini batches")
    print("=" * 80)
