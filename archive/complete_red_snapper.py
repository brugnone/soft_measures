"""Complete Red Snapper dataset only."""

from compare_ai_to_groundtruth import compare_ai_to_groundtruth

def main():
    """Run comparison for Red Snapper only."""
    ...
    print("=" * 70)
    print("COMPLETING RED SNAPPER DATASET")
    print("=" * 70)
